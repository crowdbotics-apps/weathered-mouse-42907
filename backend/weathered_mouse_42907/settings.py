"""
Django settings for weathered_mouse_42907 project.
...
ROOT_URLCONF = 'weathered_mouse_42907.urls'
...
WSGI_APPLICATION = 'weathered_mouse_42907.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "weathered_mouse_42907 API",
    "DESCRIPTION": "API documentation for weathered_mouse_42907 App",
    "VERSION": "v1",
}
